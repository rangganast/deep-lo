...
def PreProcess(PC_f1, PC_f2, T_gt, T_trans, T_trans_inv, aug_frame):    ####    pre process procedure
    ...
    # print(PC_f1_concat[0].shape)
    # print(PC_f2_concat[1].shape)
    ...
    for i in range(batch_size):
        ...
        # print(cur_PC_f1_concat.shape)
        # print(cur_PC_f2_concat.shape)
        ...
        # print("=================================")
        # print(cur_PC_f1_aft_aug.shape)
        # print(cur_PC_f2_aft_aug.shape)
