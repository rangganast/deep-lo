...
class points_dataset(data.Dataset):
    ...
    def __init__(self, is_training: int = 1, num_point: int = 150000, data_dir_list: list = [0, 1, 2, 3, 4, 5, 6],
        ...
        self.lidar_root = "/home/wicom/lidar-odometry/dataset/KITTI-Odometry/sequences"
    ...
    def __getitem__(self, index):
        ...
        pos1[:n1, :3] = point1[:, :3].astype(np.float32)
        pos2[:n2, :3] = point2[:, :3].astype(np.float32)
